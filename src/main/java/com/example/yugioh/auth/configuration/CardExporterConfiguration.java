...
import com.example.yugioh.auth.Item.CardApiReader;
import com.example.yugioh.auth.Item.CardJsonProcessor;
import com.example.yugioh.auth.Item.CardWriter;
...
public class CardExporterConfiguration {
    ...
    public Step exportCardsStep(JobRepository jobRepository,
        ...
        return new StepBuilder("exportCardsStep", jobRepository)
                .<JsonNode, List<Card>>chunk(1000, transactionManager)
