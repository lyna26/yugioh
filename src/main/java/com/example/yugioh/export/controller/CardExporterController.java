package com.example.yugioh.export.controller;
...
public class CardExporterController {
    ...
    public void exportApiData() {
        try {
            ...
            var jobExecution = jobLauncher.run(exportCardsJob, params);

            log.info("Job started: {}", jobExecution.getJobInstance().getInstanceId());
        } catch (Exception  e) {
