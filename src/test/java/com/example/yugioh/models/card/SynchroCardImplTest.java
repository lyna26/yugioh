...
class SynchroCardImplTest {
    ...
    void when_monster_card_initialization_then_Successful() throws SQLException {
        ...
        SynchroCardImpl monsterCard = new SynchroCardImpl(QUERY_RESULT) {};
    ...
    public void when_monster_card_initialization_then_failure_1() throws SQLException {
        ...
        assertThrows(CardInitializationException.class, () -> new SynchroCardImpl(QUERY_RESULT) {});
    }
